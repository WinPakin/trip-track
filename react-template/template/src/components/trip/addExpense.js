...
handleSubmit(event) {
  ...
  render() {
    ...
    const MemberLst = memberLst.map( personName => 
        ...
        />
        <label className="form-check-label" for={personName}>
        {personName}
        </label>
    </div>
        );
    ...
    return (
        ...
        <form>
                ...
                <div className="form-group row my-2">
                    <label for="expenseName" className="col-sm-2 col-form-label">Expense Name</label>
        ...
        <form>
                ...
                <div className="form-group row">
                    <label for="expenseAmount" className="col-sm-2 col-form-label">Expense Amount</label>
                    <div className="col-sm-10">
        ...
        <form>
                ...
                <fieldset className="form-group">
                    ...
                    <div className="col-sm-10">
                        ...
                        <label className="form-check-label" for="perPerson">
                            Per Person
                        </label>
                        </div>
                        <div className="form-check">
                        ...
                        <label className="form-check-label" for="total">
                            Total
                        </label>
                        </div>
                    </div>
                ...
                <fieldset className="form-group">
                    <div className="row">
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" for="transport">
                            Transportation
                            </label>
                        </div>
                        <div className="form-check">
                            ...
                            <label className="form-check-label" for="lodging">
                            Lodging
                            </label>
                        </div>
                        <div className="form-check">
                            ...
                            <div className="form-check">
                                ...
                                <label className="form-check-label" for="tours">
                                Tours
                                </label>
                            </div>
                            <div className="form-check">
