...
//Your Debt
export const SET_YOUR_DEBT = 'SET_YOUR_DEBT';
export const SET_YOUR_DEBT_LOADING = 'SET_YOUR_DEBT_LOADING';

//Net Payment
export const SET_NET_PAYMENT = 'SET_NET_PAYMENT';
export const SET_NET_PAYMENT_LOADING = 'SET_NET_PAYMENT_LOADING';
